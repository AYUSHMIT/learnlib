 ...
 * (C) 2021 – University of Mons, University Antwerpen for the interfaces SingleQueryOracleROCA and SingleQueryCounterValueOracle.
...
public interface SingleQueryOracle<I, D> extends MembershipOracle<I, D> {
    ...
    interface SingleQueryOracleROCA<I> extends SingleQueryOracle<I, Boolean>, ROCAMembershipOracle<I> {}
